    ...
    try {
      ...
      for (const item of cart) {
        ...
        // KOMPETISI
          ...
          if (existing) {
            toast.warning('Anda sudah terdaftar di kompetisi ini!');
            continue;
          }
    ...
    <div className="min-h-screen f-body" style={{ background: C.asphalt, color: C.paper }}>
      ...
      {bookingUnit && (
        <Modal onClose={() => setBookingUnit(null)} title={bookingUnit.cat}>
          <h3 className="f-display font-bold text-2xl mt-1" style={{ color: C.paper }}>{bookingUnit.name}</h3>
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          >
            <div className="flex items-center justify-between p-5 border-b" style={{ borderColor: C.line }}>
              <div className="f-display font-bold text-xl" style={{ color: C.paper }}>Troli Kamu</div>
              <button onClick={() => setCartOpen(false)}><X size={20} style={{ color: C.steel }} /></button>
            </div>
              ...
              {cart.map((item) => (
                ...
                >
                  <div>
                    ...
                    <div className="font-semibold text-sm mt-0.5" style={{ color: C.paper }}>{item.name}</div>
            ...
            <div className="p-5 border-t" style={{ borderColor: C.line }}>
              ...
              <button
                disabled={cart.length === 0 && foodOrder.length === 0}
      ...
      {checkoutDone && (
        <Modal onClose={() => setCheckoutDone(false)}>
          <div className="text-center py-4">
            ...
            <h3 className="f-display font-bold text-2xl mt-4" style={{ color: C.paper }}>Pesanan Terkonfirmasi</h3>
